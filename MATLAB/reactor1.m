...
while(L>E)
    ...
    f(1)=a0-2*x(1)-tau*kp*x(1)*x(2)-tau*kq*x(1)*x(3);
    f(2)=b0-2*x(2)-tau*kp*x(1)*x(2);
    f(3)=-2*x(3)+tau*kp*x(1)*x(2)-tau*kq*x(1)*x(3);
    f(4)=-2*x(4)+tau*kq*x(1)*x(3);
    
    df1dx1=-2-tau*kp*x(2)-tau*kq*x(3);
    df1dx2=-tau*kp*x(1);
    df1dx3=-tau*kq*x(1);
    df1dx4=0;
